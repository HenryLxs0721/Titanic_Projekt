...
######
#check data & find what to clean
summary(train_df)   #find NAs
summary(test_df)    #find NAs
glimpse(train_df)   #view datatype
glimpse(test_df)    #view datatype
view(train_df)      #recheck
view(test_df)       #recheck
